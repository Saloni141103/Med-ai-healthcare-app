...
export default function SymptomInputPage() {
  ...
  const handleAnalyze = async () => {
    ...
    if (typeof window !== "undefined") {
      sessionStorage.setItem("symptom-analysis", JSON.stringify(analysisData))
    }
        ...
        >
          ...
          <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
            <Button
              ...
              size="lg"
              className="w-full h-20 text-lg font-bold rounded-3xl bg-gradient-to-r from-blue-600 via-teal-600 to-blue-600 bg-[length:200%_100%] hover:bg-[position:100%_0] transition-all duration-500 shadow-xl"
